...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/TechnicallyComputers/Klonoa-Door-to-Phantomile/total)](https://github.com/TechnicallyComputers/Klonoa-Door-to-Phantomile/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/TechnicallyComputers/Klonoa-Door-to-Phantomile/latest/total)](https://github.com/TechnicallyComputers/Klonoa-Door-to-Phantomile/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/TechnicallyComputers/Klonoa-Door-to-Phantomile)](https://github.com/TechnicallyComputers/Klonoa-Door-to-Phantomile/releases/latest)
<!-- /retcomm-readme-metrics -->

<!-- retcomm-readme-boxart -->
<p align="center">
  <img src="launcher_assets/img/boxart.png" alt="Klonoa - Door to Phantomile box art" width="280">
</p>
<!-- /retcomm-readme-boxart -->
